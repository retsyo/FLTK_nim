...
Fl_Menu_AddImageLabel(bar, "File/Test1", "Test", "media/8x8.png", 0, nil, Fl_ALIGN_IMAGE_OVER_TEXT, Fl_ALIGN_LEFT)
Fl_Menu_AddImageLabel(bar, "File/Test2", "Test", "media/8x8.png", 0, nil, Fl_ALIGN_TEXT_OVER_IMAGE, Fl_ALIGN_RIGHT)

Fl_Menu_AddImageLabel(bar, "File/Open1", "Open...", "media/16x16.png", 0, nil, Fl_ALIGN_IMAGE_NEXT_TO_TEXT, Fl_ALIGN_LEFT or FL_ALIGN_TOP)
Fl_Menu_AddImageLabel(bar, "File/Open2", "Open...", "media/16x16.png", 0, nil, Fl_ALIGN_IMAGE_NEXT_TO_TEXT, Fl_ALIGN_CENTER)
Fl_Menu_AddImageLabel(bar, "File/Open3", "Open...", "media/16x16.png", 0, nil, Fl_ALIGN_IMAGE_NEXT_TO_TEXT, Fl_ALIGN_RIGHT or FL_ALIGN_BOTTOM)
