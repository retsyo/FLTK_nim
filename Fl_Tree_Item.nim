...
proc TreeCB  (self: ptr Fl_Widget, tree: pointer){.cdecl.} =
  Fl_TreeSetConnectorColor tree, Fl_RGB_Color(rand(255), rand(255), rand(255))
  ...
  Fl_Tree_ItemSetLabelfont(item, rand(14))
  Fl_Tree_ItemSetLabelsize(item, 12 + rand(20))
  Fl_Tree_ItemSetLabelfgcolor(item, Fl_RGB_Color(rand(255), rand(255), rand(255)))
  Fl_Tree_ItemSetLabelbgcolor(item, Fl_RGB_Color(rand(255), rand(255), rand(255)))
  ...
  if nChilds>0 :
    for index in 0 .. nChilds-1:
      ...
      if not child.isNil :
        Fl_Tree_ItemSetLabelFont(child, rand(14))
        Fl_Tree_ItemSetLabelSize(child, 12+rand(20))
        Fl_Tree_ItemSetLabelFGColor(child, Fl_RGB_Color(rand(255), rand(255), rand(255)))
        Fl_Tree_ItemSetLabelBGColor(child, Fl_RGB_Color(rand(255), rand(255), rand(255)))

  # trigger an redraw event
  Fl_WidgetRedraw cast[ptr Fl_Widget](tree)
...
var win  = cast[ptr Fl_Widget](Fl_Double_WindowNew(200, 400))
