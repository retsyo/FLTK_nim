...
proc StuffCB(self: ptr Fl_Widget) =
  ...
  for i in 1 .. nLoops:
    ...
    if newValue != oldValue :
      ...
      Fl_WidgetCopyLabel prg, strValue # set progress text
      Fl_WidgetSetSelectionColor prg, Fl_RGB_Color(ubyte(200-newValue*2), ubyte(newValue*2), ubyte(0))
...
proc ExitCB(self: ptr Fl_Widget,  btnStuff: ptr any) =
  # calculation running ?
